...
- Customization in color, size, & shape. 
  Additionally, it will allow the user to input preferred color, shape, and size.
- Randomization.
...
## Milestones:
  ...
  - Week 2
    1. Continue to work on customization. 
    2. Impliment randomization and set parameters for a general design to follow. 
  - Week 3 (Final)
    1. Attempt an animated feature.
